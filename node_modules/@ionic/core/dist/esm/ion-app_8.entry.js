 ...
 */
import { r as registerInstance, h, H as Host, f as getElement, d as createEvent, e as readTask, i as forceUpdate, w as writeTask } from './index-27668d5b.js';
import { b as getIonMode, c as config, a as isPlatform } from './ionic-global-8fa0f940.js';
...
import { t as transition } from './index-a97c95a7.js';
    ...
    componentDidLoad() {
        {
            rIC(async () => {
                ...
                if (config.getBoolean('statusTap', isHybrid)) {
                    import('./status-tap-129c01cf.js').then((module) => module.startStatusTap());
                }
...
const RouterOutlet = class {
    ...
    async connectedCallback() {
        ...
        this.gesture = (await import('./swipe-back-a6f386fc.js')).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => { var _a; return (_a = this.ani) === null || _a === void 0 ? void 0 : _a.progressStep(step); }, (shouldComplete, step, dur) => {
            if (this.ani) {
                this.ani.onFinish(() => {
                    this.gestureOrAnimationInProgress = false;
                    if (this.swipeHandler) {
